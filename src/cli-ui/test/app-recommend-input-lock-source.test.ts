...
assert.match(appSource, /inputFocus=\{\(!confirm \|\| Boolean\(selectedConfirmInput\)\) && rawModeAvailable && !isExiting && !helpPanel && !languagePanel\?\.active && !themePanel\?\.active && !isModelPanelActive && !recommendInputLocked\}/);
